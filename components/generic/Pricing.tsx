...
import { clerkPricingDarkAppearance, clerkPricingLightAppearance } from "@/lib/clerk-pricing-appearance";
        ...
        return (
            <section id="pricing" className="section-shell mt-6 px-5 py-16 sm:px-8 sm:py-20 lg:px-12">
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="w-full h-[400px] animate-pulse rounded-[1.75rem] bg-card/40" />
                </div>
            </section>
        );
    }

    const appearance = resolvedTheme === "dark" ? clerkPricingDarkAppearance : clerkPricingLightAppearance;
        ...
        <section id="pricing" className="section-shell mt-6 px-5 py-16 sm:px-8 sm:py-20 lg:px-12">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="w-full rounded-[1.75rem] border border-border/60 bg-card/40 p-4 sm:p-6 lg:p-8">
                    <PricingTable for="user" appearance={appearance} />
                </div>
            </div>
        </section>
    )
