...
export const HERO_VIDEO_SRC = "https://ik.imagekit.io/z9a6h0pnz/hero.mp4";

export const SHOWCASE_BG_VIDEO_SRC = "https://ik.imagekit.io/z9a6h0pnz/showcase.mp4";
...
export const FEATURED_STYLES = [
    { label: "Storybook 3D", image: "/examples/storybook-example.png" },
    { label: "Anime Cel", image: "/examples/anime-example.png" },
    { label: "Clay Render", image: "/examples/clay-example.png" },
    { label: "Pixart", image: "/examples/pixar-example.png" },
] as const;
